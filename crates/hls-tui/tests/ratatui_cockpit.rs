...
fn cockpit_reflects_keyboard_view_pause_density_and_help_state() {
    ...
    assert!(rendered.contains("click watchlist row selects"));
    assert!(rendered.contains("click pane rails focus"));
...
fn help_overlay_color_mode_renders_operator_keyboard_map() {
    ...
    assert!(colored.contains("click watchlist row selects"));
    assert!(colored.contains("click pane rails focus"));
...
fn narrow_help_overlay_renders_compact_operator_map() {
    ...
    assert!(plain.contains("click rows/rails"));
