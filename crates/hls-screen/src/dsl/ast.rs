...
pub enum Field {
    ...
    ResilienceState,
    TradeabilityState,
    FeeTradeabilityState,
    FeeExpectedRoundTripCostBps,
    FeeProfile,
...
impl Field {
    pub fn parse(input: &str) -> HlsResult<Self> {
        match input {
            ...
            "fee_tradeability_state" => Ok(Self::FeeTradeabilityState),
            "fee_expected_round_trip_cost_bps" => Ok(Self::FeeExpectedRoundTripCostBps),
            "fee_profile" => Ok(Self::FeeProfile),
