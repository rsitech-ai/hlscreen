...
- On very short terminals under 20 rows, `hls live --tui` switches to a clickable `MICRO LAYOUT` command rail that keeps the focused pane, resize-safe controls, color diagnostics, and read-only status visible.
